...
const features = [
  ...
  },
  {
    icon: "📊",
    title: "מעקב שוטף",
    text: "הפלטפורמה עוקבת אחר מדדי SEL לאורך הזמן ומתריעה כאשר נדרשת תשומת לב — מדד ויסות, שייכות, עבודת צוות.",
  },
  {
    icon: "🔧",
    title: "התאמה בזמן אמת",
    text: "כאשר מזוהה ירידה במדד מסוים, העוזר מציע שינוי בפעילות המפגש הבא — ומספק הנחיה ברורה לצוות.",
  },
  {
    icon: "🧑‍⚕️",
    title: "הסלמה אנושית",
    text: "במקרים מורכבים — העוזר מפנה לאיש מקצוע. הצוות הקליני זמין לליווי תוך 24 שעות. ה-AI הוא כלי עזר, לא תחליף.",
  },
];
